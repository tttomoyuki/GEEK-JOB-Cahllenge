 ...
 * @author guest1Day
 */
@WebServlet(name = "DBtest_4", urlPatterns = {"/DBtest_4"})
public class DBtest_4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DBtest_4.class.getName()).log(Level.SEVERE, null, ex);
