 ...
 * @author guest1Day
 */
@WebServlet(name = "DBtest_5", urlPatterns = {"/DBtest_5"})
public class DBtest_5 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DBtest_5.class.getName()).log(Level.SEVERE, null, ex);
