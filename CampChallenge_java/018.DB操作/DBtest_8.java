 ...
 * @author guest1Day
 */
@WebServlet(name = "DBtest_8", urlPatterns = {"/DBtest_8"})
public class DBtest_8 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DBtest_8.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
