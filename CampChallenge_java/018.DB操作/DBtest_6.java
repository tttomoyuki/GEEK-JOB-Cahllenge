 ...
 * @author guest1Day
 */
@WebServlet(name = "DBtest_6", urlPatterns = {"/DBtest_6"})
public class DBtest_6 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DBtest_6.class.getName()).log(Level.SEVERE, null, ex);
