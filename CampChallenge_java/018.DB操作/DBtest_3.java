 ...
 * @author guest1Day
 */
@WebServlet(name = "DBtest_3", urlPatterns = {"/DBtest_3"})
public class DBtest_3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DBtest_3.class.getName()).log(Level.SEVERE, null, ex);
