...
public class UserDataDAO {
    ...
    public ArrayList<UserDataDTO> search(UserDataDTO ud) throws SQLException{
        ...
        try{
            ...
            ArrayList<UserDataDTO> search = new ArrayList<UserDataDTO>();
            while(rs.next()){
    ...
    public ArrayList<UserDataDTO> select ()throws SQLException{
        Connection con = null;
        PreparedStatement st = null;
        try{
            con = DBManager.getConnection();
            ...
            ArrayList<UserDataDTO> select =new ArrayList<UserDataDTO>();
    ...
    public void update (UserDataDTO ud,int i) throws SQLException{
        Connection con = null;
        PreparedStatement st = null;
        try{
            con = DBManager.getConnection();
